...
import (
	...
	"github.com/jonaseck2/agentic-dev-pipeline/operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(devpipelinev1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "2e2007e6.devpipeline.local",
	...
	if err := (&controller.DevTaskReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "Failed to create controller", "controller", "DevTask")
		os.Exit(1)
	}
